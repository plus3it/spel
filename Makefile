...
SPEL_EPELREPO ?= epel
SPEL_EXTRARPMS ?= python3,spel-release,ec2-hibinit-agent,ec2-instance-connect,ec2-net-utils,ec2-utils,https://s3.amazonaws.com/ec2-downloads-windows/SSMAgent/latest/linux_amd64/amazon-ssm-agent.rpm
